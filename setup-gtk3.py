...
setup(name='batterymon',
      ...
      author='Denilson Sá, Rene Garcia (gtk3 port)',
      author_email='denilsonsa@gmail.com, garciamx@gmail.com',
      url='https://github.com/ixxra/batterymon-clone',
      package_dir={'batterymon': ''},
      packages = ['batterymon'],
      scripts=['batterymon', 'batterymon-gtk3'],
      data_files=[
